      ...
      <DocsPage title={t("introTitle")} lead={t("introLead")}>
        ...
        <Section id="next" title={t("introNext")}>
          <div className="flex flex-wrap gap-3">
            <Link
              href={pathFor(locale, "/docs/quickstart")}
            ...
            <Link
              href={pathFor(locale, "/docs/authentication")}
              className="border-border rounded-btn inline-flex items-center border px-4 py-2.5 text-sm font-semibold"
            >
              {t("authTitle")}
            </Link>
            ...
            <a
              ...
              className="border-border rounded-btn inline-flex items-center gap-2 border px-4 py-2.5 text-sm font-semibold"
            >
              {t("fullReference")}
