      ...
      render: (r) => {
        ...
        return (
          <div className="flex flex-col">
            ...
            <code className="text-xs text-[--color-muted]">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 h-10 w-full rounded-md border border-[--color-border] bg-[--color-bg] px-3 text-sm disabled:opacity-50"
            />
          </div>
        </div>
...
function DecisionPreview({ decision }: { decision: SourcingDecisionOut }) {
  return (
    <span className="text-xs text-[--color-muted]">
      Сейчас: <code className="text-[--color-fg]">{decision.primary}</code>
      {decision.fallback && (
        <>
          {" → "}
          <code className="text-[--color-fg]">{decision.fallback}</code>
        </>
      )}
