  ...
  const columns: Column<QueueRow>[] = [
    ...
    },
    {
      ...
      render: (r) => {
        ...
        if (!display) return <span className="text-[--color-muted]">—</span>;
        ...
        return (
          <div className="flex flex-col">
            ...
            <span className="text-xs text-[--color-muted]">{denom}</span>
          </div>
        );
      },
    },
    ...
    },
    {
      ...
      render: (r) => {
        const item = orderItem(r);
        if (!item) return <span className="text-[--color-muted]">…</span>;
