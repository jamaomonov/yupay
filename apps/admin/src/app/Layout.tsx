...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/payments/providers", label: "Провайдеры оплаты", icon: Power },
      ...
      { to: "/affiliate/applications", label: "Заявки партнёров", icon: Ticket },
      { to: "/affiliate/partners", label: "Партнёры", icon: Ticket },
      { to: "/affiliate/payouts", label: "Выплаты партнёрам", icon: Ticket },
