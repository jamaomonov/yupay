...
BRANDS: list[BrandSpec] = [
    BrandSpec(
        slug="pubg-mobile",
        category_slug="games",
        logo_url="https://cdn.yupay.io/brands/pubg-mobile.png",
        hero_image_url="https://cdn.yupay.io/brands/pubg-mobile-hero.jpg",
        accent_color="#F2A900",
        sort_order=10,
        translations=[
            TranslationSpec(
        ...
        products=[
            ProductSpec(
                ...
                image_url="https://cdn.yupay.io/products/pubg-uc.png",
                sort_order=10,
                required_fields=[
                    _player_id_field(),
                    _server_field(
            ...
            ProductSpec(
                ...
                kind="top_up",
                supplier_hint="codashop",
                image_url="https://cdn.yupay.io/products/pubg-royal-pass.png",
                sort_order=20,
                required_fields=[
                    _player_id_field(),
                    _server_field(
    ...
    BrandSpec(
        slug="steam",
        category_slug="games",
        logo_url="https://cdn.yupay.io/brands/steam.png",
        hero_image_url=None,
        accent_color="#1B2838",
        sort_order=20,
        translations=[
        ...
        products=[
            ProductSpec(
                ...
                image_url="https://cdn.yupay.io/products/steam-wallet.png",
                sort_order=10,
                required_fields=[],
                translations=[
                    TranslationSpec(
    ...
    BrandSpec(
        ...
        logo_url="https://cdn.yupay.io/brands/spotify.png",
        hero_image_url=None,
        accent_color="#1DB954",
        sort_order=10,
        translations=[
        ...
        products=[
            ProductSpec(
                ...
                image_url="https://cdn.yupay.io/products/spotify-premium.png",
                sort_order=10,
    ...
    BrandSpec(
        ...
        logo_url="https://cdn.yupay.io/brands/apple.png",
        hero_image_url=None,
        accent_color="#000000",
        sort_order=10,
        translations=[
        ...
        products=[
            ProductSpec(
                ...
                kind="voucher",
                supplier_hint="kupikod",
                image_url="https://cdn.yupay.io/products/apple-gift-card.png",
                sort_order=10,
                required_fields=[],
                translations=[
                    TranslationSpec(
    ...
    BrandSpec(
        ...
        logo_url="https://cdn.yupay.io/brands/usdt.png",
        hero_image_url=None,
        accent_color="#26A17B",
        sort_order=10,
        translations=[
        ...
        products=[
            ProductSpec(
                ...
                image_url="https://cdn.yupay.io/products/usdt-trc20.png",
                sort_order=10,
