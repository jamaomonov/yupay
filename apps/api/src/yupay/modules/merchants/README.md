...
| The published contract (`GET /merchant/v1/openapi.json`)    | `machine_openapi.py` — the app's schema narrowed to these six paths and the models they reach. **Unauthenticated and not limiter-exempt**: a contract is read before anybody has a key, and this route authenticates nobody                                                                                                                                                                                                             |
