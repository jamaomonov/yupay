    ...
    <form onSubmit={(e) => void submit(e)} className="mt-6 space-y-4">
      <label className="block">
        ...
        <input
          ...
          className="border-border bg-card-2 rounded-btn focus:border-primary/60 h-12 w-full border px-4 text-[15px] outline-none"
        />
  ...
  return (
    <main className="grid-cell flex min-h-dvh items-center justify-center px-5 py-16">
      <div className="border-border bg-card w-full max-w-sm rounded-2xl border p-7">
        ...
        <p className="text-tx-mute mt-2 text-[13px]">{t("subtitle")}</p>
