/**
 * Framework-free helpers for the Steam gift country picker — no React
 * dependency, safe to import from a page or a leaf component alike.
 * Mirrored (not imported — separate app, no shared package for this) from
 * the web storefront's own `apps/web/src/lib/regions.ts`.
 *
