...
| **Information disclosure** | Blog reader cookie or `reader_hash` written to logs                                                                                                                                         | Cookie is `HttpOnly; SameSite=Lax`; only SHA-256 is persisted; `yp_blog_reader` / `reader_hash` are on the log redactor. Identity is not an inbound IP (ADR-0073)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Tampering**              | Guest clears `yp_blog_reader` and likes/views the same post again                                                                                                                           | Accepted residual of anonymous cookies. Uniqueness is per cookie, not per person. Rate-limited like other public writes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
